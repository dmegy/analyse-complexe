...
Cependant il est vrai qu'il existe une primitive sur $\C^*\setminus \R_-$ à savoir $\Log_0$, et il est vrai qu'on peut utiliser ça pour rédiger le calcul de l'intégrale curviligne (fait en cours au tableau). Évidemment, le résultat final est quand même $2i\pi$.
\end{quote}
