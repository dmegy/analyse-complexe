...
\begin{theoreme}[Biholomorphismes du disque : vu en TD]
\end{theoreme}
...
%\begin{exo}% Liouville sur un plan épointé
%\end{exo}
...
Soit $z_0$ une singularité essentielle d'une fonction holomorphe $f$.
Alors, ...
...
\begin{proposition}
Équivalence des deux définitions possibles
\end{proposition}
...
Calculs avec les ordres des zéros et pôles. Résidus. Techniques de calcul de calcul de résidus.
