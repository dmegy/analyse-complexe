...
\section{Holomorphie (et calcul diff, et nombres complexes, et topo)}

% convergences d'intégrales
...
\begin{ideeFausse}
Si le résidu en une singularité est nul, alors la singularité est effaçable.
\end{ideeFausse}
%
%\begin{ideeFausse}
%\end{ideeFausse}
