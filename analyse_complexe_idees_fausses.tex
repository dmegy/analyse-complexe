...
Attention aux satanées intégrales (semi)convergentes:
...
Si vous écrivez \og convergente\fg{} au lieu de \og absolument convergente\fg{} ou \og intégrable\fg, les arguments deviennent en général incorrects.
...
\begin{ideeFausse} \important
Soit $U\subset \C$ un ouvert. L'anneau $\mathcal (U)$ est intègre.
\end{ideeFausse}

\begin{ideeFausse} \important
Soit $U\subset \C$ un ouvert connexe. L'anneau $\mathcal (U)$ est factoriel.
\end{ideeFausse}
